...
public extension FastisConfig {
    ...
    struct CurrentValueView {
         ...
         */
        public var placeholderTextForRanges = "SELECT_DATE_RANGE".localized
         ...
         */
        public var placeholderTextForSingle = "SELECT_DATE".localized
         ...
         */
        public var placeholderTextColor: UIColor = Theme.current.secondaryTextColor
        ...
        /**
         ...
         Default value — `.label`
         */
        public var textColor: UIColor = Theme.current.secondaryTextColor
         ...
         */
        public var textFont: UIFont = UIFont.regular(size: 17)
         ...
         */
        public var clearButtonImage: UIImage? = UIImage(name: .close_x)
         ...
         */
        public var clearButtonTintColor: UIColor = Theme.current.secondaryTextColor
         ...
         */
        public var insets = UIEdgeInsets(top: 8, left: 0, bottom: 24, right: 16)
