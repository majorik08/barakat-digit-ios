...
final class MonthHeader: JTACMonthReusableView {
    ...
    override init(frame: CGRect) {
        ...
        self.applyConfig(FastisConfig.MonthHeader(), calendar: .current)
...
public extension FastisConfig {
    ...
    struct MonthHeader {
        ...
        /**
         ...
         Default value — `.label`
         */
        public var labelColor: UIColor = Theme.current.primaryTextColor
         ...
         */
        public var labelFont: UIFont = UIFont.semibold(size: 17)
