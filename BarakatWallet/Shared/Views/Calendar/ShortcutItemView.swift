...
public extension FastisConfig {
    ...
    struct ShortcutItemView {
         ...
         */
        public var backgroundColor: UIColor = Theme.current.plainTableBackColor
         ...
         */
        public var font: UIFont = UIFont.regular(size: 15)
        ...
        /**
         ...
         Default value — `.label`
         */
        public var textColor: UIColor = Theme.current.primaryTextColor
        ...
        /**
         ...
         Default value — `.white`
         */
        public var textColorOnSelected: UIColor = Theme.current.whiteColor
