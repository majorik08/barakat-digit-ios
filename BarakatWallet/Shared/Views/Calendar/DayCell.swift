...
public extension FastisConfig {
    ...
    class DayCell {
         ...
         */
        public var dateLabelFont: UIFont = UIFont.regular(size: 17)
        ...
        /**
         ...
         Default value — `.label`
         */
        public var dateLabelColor: UIColor = Theme.current.primaryTextColor
         ...
         */
        public var dateLabelUnavailableColor: UIColor = Theme.current.secondaryTextColor
         ...
         */
        public var selectedBackgroundColor: UIColor = Theme.current.tintColor
        ...
        /**
         ...
         Default value — `.white`
         */
        public var selectedLabelColor: UIColor = Theme.current.whiteColor
         ...
         */
        public var onRangeBackgroundColor: UIColor = Theme.current.tintColor.withAlphaComponent(0.2)
        ...
        /**
         ...
         Default value — `.label`
         */
        public var onRangeLabelColor: UIColor = Theme.current.primaryTextColor
    ...
    final class TodayCell: DayCell {
        ...
        /**
         ...
         Default value — `.label`
         */
        public var circleViewColor: UIColor = Theme.current.tintColor
        ...
        /**
         ...
         Default value — `.tertiaryLabel`
         */
        public var circleViewUnavailableColor: UIColor = Theme.current.secondaryTextColor
        ...
        /**
         ...
         Default value — `.white`
         */
        public var circleViewSelectedColor: UIColor = Theme.current.whiteColor
        ...
        /**
         ...
         Default value — `.label`
         */
        public var circleViewOnRangeColor: UIColor = Theme.current.tintColor
