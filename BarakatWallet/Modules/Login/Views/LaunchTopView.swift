...
class LaunchTopView: UIView {
    ...
    func setup() {
        ...
        NSLayoutConstraint.activate([
            ...
            self.appNameLabel.heightAnchor.constraint(equalToConstant: 18),
            ...
            self.appInfoLabel.heightAnchor.constraint(equalToConstant: 18),
            ...
            self.pageControl.topAnchor.constraint(equalTo: self.storiesView.bottomAnchor, constant: 10),
