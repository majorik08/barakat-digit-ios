...
class HistoryFilterView: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    let collectionView: UICollectionView = {
        ...
        view.register(HistoryFilterCell.self, forCellWithReuseIdentifier: "cell")
    ...
    override init(frame: CGRect) {
        ...
        NSLayoutConstraint.activate([
            ...
            self.collectionView.topAnchor.constraint(equalTo: self.topAnchor, constant: 8),
            self.collectionView.rightAnchor.constraint(equalTo: self.rightAnchor, constant: 0),
            self.collectionView.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: -2),
        ])
    ...
    func configure(items: [HistoryFilter]) {
        self.filters = items
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! HistoryFilterCell
...
class HistoryFilterCell: UICollectionViewCell {
    ...
    func configure(filter: HistoryFilter) {
