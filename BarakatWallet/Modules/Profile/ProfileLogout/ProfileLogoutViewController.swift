...
class ProfileLogoutViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            ...
            self.rootView.leftAnchor.constraint(equalTo: self.view.leftAnchor, constant: 20),
            self.rootView.rightAnchor.constraint(equalTo: self.view.rightAnchor, constant: -20),
