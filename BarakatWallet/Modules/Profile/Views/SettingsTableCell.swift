...
class SettingsTableCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        NSLayoutConstraint.activate([
            ...
            self.infoLabel.topAnchor.constraint(equalTo: self.rootView.topAnchor, constant: 10),
            self.infoLabel.rightAnchor.constraint(equalTo: self.iconView.leftAnchor, constant: -10),
            self.infoLabel.bottomAnchor.constraint(equalTo: self.rootView.bottomAnchor, constant: -10),
            self.iconView.rightAnchor.constraint(equalTo: self.rootView.rightAnchor, constant: -20),
            self.iconView.centerYAnchor.constraint(equalTo: self.rootView.centerYAnchor),
            self.iconView.heightAnchor.constraint(equalTo: self.rootView.heightAnchor, multiplier: 0.4),
