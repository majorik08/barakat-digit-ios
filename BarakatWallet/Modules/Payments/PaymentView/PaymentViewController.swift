...
class PaymentViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            ...
            rootHeight,
            self.balanceView.leftAnchor.constraint(equalTo: self.rootView.leftAnchor, constant: 16),
            self.balanceView.topAnchor.constraint(equalTo: self.rootView.topAnchor, constant: 20),
            self.balanceView.rightAnchor.constraint(equalTo: self.rootView.rightAnchor, constant: -16),
            self.stackView.leftAnchor.constraint(equalTo: self.rootView.leftAnchor, constant: 16),
            self.stackView.topAnchor.constraint(equalTo: self.rootView.topAnchor, constant: 20),
            self.stackView.rightAnchor.constraint(equalTo: self.rootView.rightAnchor, constant: -16),
            self.nextButton.leftAnchor.constraint(equalTo: self.rootView.leftAnchor, constant: 30),
            self.nextButton.topAnchor.constraint(equalTo: self.stackView.bottomAnchor, constant: 30),
