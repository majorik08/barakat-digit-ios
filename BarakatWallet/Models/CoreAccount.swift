...
final class CoreAccount: Codable {
    ...
    init(accountId: String, token: String, lastSelected: Double, lockState: LockState, pin: String?) {
    ...
    @discardableResult
    public static func login(accountId: String, token: String, lastSelected: Double) -> CoreAccount {
        let account = CoreAccount(accountId: accountId, token: token, lastSelected: lastSelected, lockState: LockState(), pin: nil)
